...
/* Enable Auto Acknowledgment (reset value: 0b00111111) */
#define EN_AA				0x01
...
#define AW(b)							(b < 3 ? AW_INVALID : (b & SETUP_AW_MASK) - 2)											// write: 0 <= b <= 5 valid values
#define AW_RD(b)					((b & SETUP_AW_MASK)  ? (b & SETUP_AW_MASK) + 2 : AW_INVALID) 	//  read: 0 <= b <= 5 valid values
...
#define RETR_ARC(v)				(v & RETR_ARC_MASK)		// Auto Retransmit count: 0 <= v <= 15 valid values
#define ARC_DISABLE				0b0000

/* RF channel (reset value: 0b00000010), frequencies from 2.400GHz to 2525GHz */
#define RF_CH						0x05	// 0 - 125 channels range for 1MHz resolution bandwidth wider at 250Kbps/1Mbps
																// 0 - 62 channels range for 2MHz resolution bandwidth wider at 2Mbps
#define RF_CH_RST				0b00000010
#define RF_CH_MASK			0b01111111
#define CH(c)							(c & RF_CH_MASK)
#define CH_MIN						10
#define CH_MAX_2MBPS	54		//63
#define CH_MAX_1MBPS	10	//116		//126
...
#define ST_RX_P_NO(v)			((v & ST_RX_P_NO_MASK) >> 1)	// read Data pipe number for the payload
...
/* Transmit observe (reset value: 0b00000000) */
#define OBSERVE_TX					0x08
#define OBSERVE_TX_RST		0b00000000
#define TX_PLOS_CNT_MASK	0b11110000
#define TX_PLOS_CNT(v)			((v & TX_PLOS_CNT_MASK) >> 4)	// read count lost packets: 0 <= v <= 15 valid values
#define TX_ARC_CNT_MASK		0b00001111
#define TX_ARC_CNT(v)				(v &  TX_ARC_CNT_MASK)				// read count retransmit packets: 0 <= v <= 15 valid values

/* Received Power Detector read in RX mode for power levels
 * above -64dBm in the channel (reset value: 0b00000000) */
#define RPD							0x09
#define RPD_RST				0b00000000
#define RPD_MASK			0b00000001
#define RPD_64DBM			0b1
...
#define RX_PW_P0_RST	0b00000000
#define PW_P0(v)				(v & 0b00111111)	// payload pipe0 lenght: 1 <= v <= 32 valid values, 0 for pipe not used
/* Number of  bytes in RX payload in data pipe 1 (reset value: 0b00000000) */
#define RX_PW_P1			0x12
#define RX_PW_P1_RST	0b00000000
#define PW_P1(v)				(v & 0b00111111)	// payload pipe1 lenght: 1 <= v <= 32 valid values, 0 for pipe not used
/* Number of  bytes in RX payload in data pipe 2 (reset value: 0b00000000) */
#define RX_PW_P2			0x13
#define RX_PW_P2_RST	0b00000000
#define PW_P2(v)				(v & 0b00111111)	// payload pipe2 lenght: 1 <= v <= 32 valid values, 0 for pipe not used
/* Number of  bytes in RX payload in data pipe 3 (reset value: 0b00000000) */
#define RX_PW_P3			0x14
#define RX_PW_P3_RST	0b00000000
#define PW_P3(v)				(v & 0b00111111)	// payload pipe3 lenght: 1 <= v <= 32 valid values, 0 for pipe not used
/* Number of  bytes in RX payload in data pipe 4 (reset value: 0b00000000) */
#define RX_PW_P4			0x15
#define RX_PW_P4_RST	0b00000000
#define PW_P4(v)				(v & 0b00111111)	// payload pipe4 lenght: 1 <= v <= 32 valid values, 0 for pipe not used
/* Number of  bytes in RX payload in data pipe 5 (reset value: 0b00000000) */
#define RX_PW_P5			0x16
#define RX_PW_P5_RST	0b00000000
#define PW_P5(v)				(v & 0b00111111)	// payload pipe5 lenght: 1 <= v <= 32 valid values, 0 for pipe not used
...
*/
#define REGISTER_MASK						0b00011111		// 5 bit register address map
...
#define ACTIVATE										0b01010000				// always followed by data 0x73
#define ACTIVATE_DATA							0x73

#endif //	__NRF24L01_IO_H__
