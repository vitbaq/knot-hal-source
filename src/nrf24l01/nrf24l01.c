...
void nrf24l01_dump_details(void)
{
	...
	printf("CONFIG=%#04x STATUS=%#04x FIFO_STATUS=%#04x\n", inr(CONFIG), inr(STATUS), inr(FIFO_STATUS));
	printf("RF_CH=%#04x RF_SETUP=%#04x\n", inr(RF_CH), inr(RF_SETUP));
	printf("SETUP_AW=%#04x SETUP_RETR=%#04x\n", inr(SETUP_AW), inr(SETUP_RETR));
	printf("OBSERVE_TX=%#04x FEATURE=%#04x\n", inr(OBSERVE_TX), inr(FEATURE));
	printf("EN_RXADDR=%#04x EN_AA=%#04x DYNPD=%#04x\n", inr(EN_RXADDR), inr(EN_AA), inr(DYNPD));
	printf("RX_PW_P0=%#04x RX_PW_P1=%#04x\n", inr(RX_PW_P0), inr(RX_PW_P1));
	printf("RX_PW_P2=%#04x RX_PW_P3=%#04x\n", inr(RX_PW_P2), inr(RX_PW_P3));
	printf("RX_PW_P4=%#04x RX_PW_P5=%#04x\n", inr(RX_PW_P4), inr(RX_PW_P5));
